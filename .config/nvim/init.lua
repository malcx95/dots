...
vim.keymap.set('n', '<leader>dx', Toggle_diagnostics, { desc = 'Toggle diagnostics' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<C-b>', require('telescope.builtin').lsp_definitions, 'Goto Definition')
...
-- make clangd work for esp32
require 'lspconfig'.clangd.setup {
  capabilities = require('cmp_nvim_lsp').default_capabilities(vim.lsp.protocol.make_client_capabilities()),
  cmd = {
    "clangd",
    "--background-index",
    "--query-driver=/home/malcolm/.platformio/packages/toolchain-xtensa-esp32s3/bin/xtensa-esp32s3-elf-g++*"
  },
  on_attach = on_attach,
